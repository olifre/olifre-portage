...
SRC_URI="alice? (
	...
	dteam? (
		...
		https://linuxsoft.cern.ch/wlcg/el9/x86_64/wlcg-iam-lsc-dteam-${WLCG_IAM_RPM_VER}.el9.noarch.rpm
	)
	lhcb? (
	...
	ops? (
		https://linuxsoft.cern.ch/wlcg/el9/x86_64/wlcg-voms-ops-${RPM_VER}.el7.noarch.rpm
