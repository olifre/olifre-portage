...
# curl -s https://repository.egi.eu/sw/production/cas/1/current/tgz/ | grep tar.gz | sed 's#^<a href="\([^"]*\)".*#\thttps://repository.egi.eu/sw/production/cas/1/current/tgz/\1#' | sed 's/1.122/${PV}/'
