...
SRC_URI="http://repository.egi.eu/sw/production/cas/1/current/tgz/ca_AEGIS-${PV}.tar.gz
	...
	http://repository.egi.eu/sw/production/cas/1/current/tgz/ca_UGRID-${PV}.tar.gz
	...
	http://repository.egi.eu/sw/production/cas/1/current/tgz/ca_pkIRISGrid-${PV}.tar.gz
